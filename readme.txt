=== Nostrichat Plugin ===
Contributors: Gzuuus (Wordpress plugin) Pablo7zf (Nostrichat development)
Version: 1.0.0
Licence: ?
Licence URI: ?

Description
The Nostrichat plugin allows you to easily integrate Nostrichat into your WordPress site. With this plugin, you can add a live chat widget to your pages or posts, and allow site visitors to communicate in real time. 
The shortcode will create a chat room based on the URL where it is inserted.
